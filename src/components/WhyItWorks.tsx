  ...
  return (
    <section className="relative bg-navy-950 py-32 md:py-44 overflow-hidden">
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse 60% 50% at 50% 50%, rgba(192,21,42,0.07) 0%, transparent 70%)",
        }}
        aria-hidden="true"
      />
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
        ...
        <blockquote className="mb-10">
          <p className="font-playfair text-3xl md:text-5xl lg:text-6xl font-black text-navy-100 leading-tight tracking-tight">
        ...
        {/* Supporting body */}
        <p className="text-navy-300 text-lg leading-relaxed max-w-xl mx-auto mb-8">
          {SITE.insight.body}
        </p>

        {/* Callout pill */}
        <div className="inline-block border border-navy-600 px-6 py-3 rounded-sm">
          <p className="font-mono text-xs font-bold tracking-[0.2em] text-navy-300 uppercase">
        ...
        <div className="mt-20 grid grid-cols-1 md:grid-cols-3 gap-8 text-left">
          {[
            ...
            <div key={pt.label} className="border-t border-navy-700 pt-6">
              ...
              <p className="text-navy-300 text-sm leading-relaxed">{pt.body}</p>
            </div>
          ))}
        </div>
      </div>
